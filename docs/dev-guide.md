...
151 tests covering auth, RBAC, chunking, citation gate, crawler SSRF, supervisor routing, LLM factory, publishing/suppression, admin routes, and HTTP health checks.
...
| [test-cases.md](./test-cases.md) | Full test case document — 151 tests with IDs, preconditions, expected results |
